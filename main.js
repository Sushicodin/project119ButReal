...
//console.log("random sketch="+quick_draw_data_set[random_number]);

sketch=quick_draw_data_set[random_number];

document.getElementById("labelDrawing").innerHTML="Sketch To Be Drawn : "+sketch;
...
function classifyCanvas(){
    ...
    function gotResult(error,results){
        ...
        if (error){
            ...
            document.getElementById("confidenceDrawing").innerHTML="Confidence : "+Math.round(results[0].confidence*100)+"%";
...
if(timer_counter>400){
    timer_counter=0;
    random_number=Math.floor((Math.random()*quick_draw_data_set.length)+1);
    document.getElementById("labelDrawing").innerHTML="Sketch to be drawn:"+quick_draw_data_set[random_number];
    background("blue");
}
